...
### A calendar sync that runs out of time finishes later (89)

Numbered 89 because 89 and 90 were never used and this belongs beside the sync
files rather than at the end of the tail. Safe there: behavior only, its own
