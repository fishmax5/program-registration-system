...
| File | | What is in it |
|---|--:|---|
| `16_menu_and_triggers.gs` | 622 | `onOpen`, the menu tree (the Admin submenu is now attached for everyone — the gate lives inside its destructive items, not on the menu), trigger installation. |
