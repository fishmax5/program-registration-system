...
function createProgramLeaderSheet(programValue) {
  ...
  emails.forEach(email => {
    try {
      ...
      shared.push(email);
      // One line in the office's daily record (section 85). Everybody on the
      // Admin Notification Emails table is already an editor of this file —
      // what they had no way of knowing is WHO ELSE it was just shared with.
      noteForOffice('filesShared',
